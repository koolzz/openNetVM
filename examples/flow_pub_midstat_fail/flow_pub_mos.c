...
/**
 * Set up a mempool to store pubsub_msg structs
  */
  #if 0
  static int init_pubsub_msg_pool(void){
        printf("Creating pubsub pool\n");
        pubsub_msg_pool = rte_mempool_create(_PUBSUB_POOL_NAME, MAX_NFS * NF_MSG_QUEUE_SIZE, PUBSUB_MSG_SIZE, 
                                0, 0, NULL, NULL, NULL, NULL, rte_socket_id(), NO_FLAGS);
